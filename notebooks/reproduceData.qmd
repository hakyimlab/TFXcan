...
You can use this repository to train the DL-based Enpact models from scratch. The repository is [here](https://github.com/hakyimlab/TFPred-snakemake/tree/main). 
...
output_file <-' /beagle3/haky/users/temi/projects/TFXcan/misc/reruns/enpact_predictions/ENPACT_48.1KG.CWAS_ARBS.predictions.2025-04-28.rds.gz' 
...
enpact_weights <- '/beagle3/haky/users/temi/projects/TFPred-snakemake/data/ENPACT_734_2025-04-24/statistics/ENPACT_734_2025-04-24.compiled_weights.lambda.1se.txt.gz' 
output_file <-' /beagle3/haky/users/temi/projects/TFXcan/misc/reruns/enpact_predictions/ENPACT_48.BACA.CWAS_ARBS.predictions.2025-04-28.rds.gz' 
...
### First prepare the z-ratio matrices

###

```{r}
script <- '/beagle3/haky/users/temi/projects/TFXcan/src/repeat_flash.sbatch'
datafile <- '/beagle3/haky/users/temi/projects/TFXcan/data/tenerife/PrCa.tfxcan.zratios.matrix.rds'
output_basename <- '/beagle3/haky/users/temi/projects/TFXcan/data/tenerife/repeat_flash/prca_risk.retrain_repeats'
priorL <- 'ebnm_point_exponential'
priorF <- 'ebnm_point_exponential'
greedy_Kmax <- 40L
batch_list <- "/beagle3/haky/users/temi/projects/TFXcan/data/tenerife/repeat_flash/prca_risk.random_subsets.txt"
```

```{r}
glue::glue("sbatch {script} {datafile} {output_basename} {priorL} {priorF} {greedy_Kmax} {batch_list}")
```
