...
peak_files_dir <- glue('{freedman_dir}/compressed-peak-files')
...
FOXA1_files <- lapply(FOXA1_files, data.table::fread) # 29 foxa1 chip-seq data
...
chip_peak_headers <- c('chr', 'start', 'end', 'id', 'score')
TF_CHIP_all <- do.call(rbind, FOXA1_files)
