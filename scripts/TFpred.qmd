---
title: "Build Kawakami models: elastic net and xgboost"
author: "Temi"
...
### Utility functions
```{r}
source('./glmnet-utility-functions.R')
```
...
```{r}
params <- list(colsample_bytree = 0.7, max_depth=9, eta=c(0.01), gamma=20, lambda=25, nthread=8, verbosity=2, objective = "binary:logistic", eval_metric='auc')
xgb_model_trained <- xgb.train(data=dtrain, params=params, nrounds=20)
xgb_model_trained
```
