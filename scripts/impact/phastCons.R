...
library(data.table)
# headers are here: http://genome.ucsc.edu/cgi-bin/hgTables
phastCons46 <- data.table::fread('http://hgdownload.cse.ucsc.edu/goldenPath/hg19/database/phastCons46wayPrimates.txt.gz')
