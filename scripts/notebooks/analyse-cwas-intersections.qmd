...
```
```{r}
predixcan_result_dir <- '/lus/grand/projects/TFXcan/imlab/users/temi/projects/prediXcan/output'
baca_models <- c('lasso', 'lasso.as', 'lasso.plasma', 'top1.as', 'top1.qtl', 'top1')
```

```{r}
baca_predictions <- data.table::fread(glue('{predixcan_result_dir}/geuvadis_99/{baca_models[1]}/baca_cwas_predict.txt'))
