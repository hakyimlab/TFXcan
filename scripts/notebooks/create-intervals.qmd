...
```{r}
FOXA1_predicted_motifs <- data.table::fread('/projects/covid-ct/imlab/users/temi/projects/TFXcan/data/common-files/FOXA1/FOXA1_LuCaP_scanMotifsGenomewide_sort.txt')
...
Using Kawakami data
```{r}
kawakami_peaks <- data.table::fread('/projects/covid-ct/imlab/users/temi/projects/TFXcan/data/kawakami-human/bedtools-intersected-regions/FOXA1_intersected_chip.bed')
...
TF <- 'FOXA1'
howmany <- format(400000, scientific=F)
