...
def write_logfile(predictions_log_file, id, what_to_write):
    '''
...
def enformer_predict_on_batch(batch_region, sample, model, output_dir, predictions_log_file, vcf_func, batch_num, grow_memory=True, write_log=write_log):
    '''
