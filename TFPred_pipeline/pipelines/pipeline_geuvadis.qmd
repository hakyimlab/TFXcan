...
enformer_parameters_json[['batch_size']] <- 5
enformer_parameters_json[['predict_on_n_regions']] <- 500
enformer_parameters_json[['write_log']] <- list('memory'=F, 'error'=T, 'time'=F, 'cache'=F)
enformer_parameters_json[['parsl_parameters']] <- list("job_name"=glue("enformer_predict_{dataset}_{TF}"), "num_of_full_nodes"=10, "walltime"="02:00:00", "min_num_blocks"=0, "max_num_blocks"=10, "queue"="preemptable")
