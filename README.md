...
- [reproduceData](./notebooks/reproduceData.qmd): contains step-by-step instructions to run scripts that reproduce the main results in the TFXcan paper. THIS IS NOT AN ANALYSIS SCRIPT. It is written in Quarto and can be rendered to HTML or PDF, or run interactively in RStudio.
