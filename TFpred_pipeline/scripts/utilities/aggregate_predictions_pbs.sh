...
#PBS -k doe
#PBS -o /lus/grand/projects/covid-ct/imlab/users/temi/projects/TFXcan/TFpred_pipeline/logs/aggregate_predictions.out
#PBS -e /lus/grand/projects/covid-ct/imlab/users/temi/projects/TFXcan/TFpred_pipeline/logs/aggregate_predictions.err
