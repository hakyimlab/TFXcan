...
todays_date <- data_date <- '2023-01-11' #Sys.Date() #2023-01-06' #Sys.Date()
#TF <- 'GATA3'
```
...
#### Plot the mse of the training and test performance
...
tm_test <- do.call('rbind', cistrome_test_assess_metrics)[, 'mse.lambda.1se']
